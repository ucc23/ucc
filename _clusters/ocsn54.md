...
UTI_C_dup: 1.0
UTI_summary: |
    <b>OCSN 54</b> is a moderately populated, moderately dense object of high C3 quality. It is located at a very close distance from the Sun, below the mid-plane. It was recently reported in the literature.<br><br>This object shares a very small percentage of members with at least one entry reported in the same catalogue.
class3: |
...
posit_table: |
    ...
    |[Zhang et al. (2024)](https://scixplorer.org/abs/2024A%26A...692A.212Z) | 77.622 | 17.431 | -- | -- | -- | -- |
...
fpars_table: |
    ...
    | [Zhang et al. (2024)](https://scixplorer.org/abs/2024A%26A...692A.212Z) | `[Fe/H]ANN=-0.0953, [Fe/H]MCMC=-0.0635` |
shared_table: |
