...
<!-- WEBP image -->
<img id="myImage" src="https://raw.githubusercontent.com/ucc23/Q4N/main/plots/fsr1521_aladin.webp" alt="Clickable Image" style="width:355px;height:250px; cursor: pointer;">
...
function loadAladinLiteAndHideImage() {
    ...
    aladinScript.onload = function () {
        A.init.then(() => {
            let aladin = A.aladin('#aladin-lite-div', {survey:"P/DSS2/color", fov:0.16, target: "148.846 -56.609"});
            // Remove the image
...
|[Hunt & Reffert (2023)](https://ui.adsabs.harvard.edu/abs/2023A%26A...673A.114H/abstract) | 148.83 | -56.617 | 0.251 | -4.696 | 4.799 | 49.744 |
|[Cavallo et al. (2024)](https://ui.adsabs.harvard.edu/abs/2024AJ....167...12C/abstract) | 148.844 | -56.592 | 0.237 | -- | -- | -- |
| **UCC** |148.846 | -56.609 | 0.25 | -4.75 | 4.752 | 48.025 |

> <p style="text-align:center; font-weight: bold; font-size:20px">Search coordinates in <a href="https://cdsportal.u-strasbg.fr/?target=148.846,-56.609" target="_blank">CDS</a> | <a href="https://simbad.cds.unistra.fr/mobile/object_list.html?coord=148.846%20-56.609&output=json&radius=5&userEntry=fsr1521" target="_blank">Simbad</a></p>
...
| [Hunt & Reffert (2023)](https://ui.adsabs.harvard.edu/abs/2023A%26A...673A.114H/abstract) | `AV50=3.54, MOD50=12.788, logAge50=9.178` |
| [Cavallo et al. (2024)](https://ui.adsabs.harvard.edu/abs/2024AJ....167...12C/abstract) | `AV50=3.04, dMod50=13.81, logAge50=9.07, [Fe/H]50=-0.23` |
