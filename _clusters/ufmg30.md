...
<!-- WEBP image -->
<img id="myImage" src="https://raw.githubusercontent.com/ucc23/Q4N/main/plots/ufmg30_aladin.webp" alt="Clickable Image" style="width:355px;height:250px; cursor: pointer;">
...
function loadAladinLiteAndHideImage() {
    ...
    aladinScript.onload = function () {
        A.init.then(() => {
            let aladin = A.aladin('#aladin-lite-div', {survey:"P/DSS2/color", fov:0.4, target: "257.794 -48.733"});
            // Remove the image
...
| [Dias et al. (2021)](https://ui.adsabs.harvard.edu/abs/2021MNRAS.504..356D) | `Av=1.42, Dist=1175.0, logage=8.11, [Fe/H]=0.09` |
