...
UTI_C_dup: 1.0
UTI_summary: |
    <b>CWNU 2749</b> is a moderately populated, moderately dense object of high C3 quality. It is located at a moderate distance from the Sun, above the mid-plane. It was recently reported in the literature.<br><br>This object shares a very small percentage of members with at least one entry reported in the same catalogue.
class3: |
...
posit_table: |
    ...
    |[Zhang et al. (2024)](https://scixplorer.org/abs/2024A%26A...692A.212Z) | 87.316 | 33.406 | -- | -- | -- | -- |
...
fpars_table: |
    ...
    | [Hunt & Reffert (2024)](https://scixplorer.org/abs/2024A%26A...686A..42H) | `MassJ=258.207, MassTot=265.482` |
    | [Zhang et al. (2024)](https://scixplorer.org/abs/2024A%26A...692A.212Z) | `[Fe/H]ANN=-0.0806, [Fe/H]MCMC=-0.0648` |
shared_table: |
