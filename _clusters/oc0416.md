...
UTI_C_dup: 1.0
UTI_summary: |
    <b>OC 0416</b> is a sparse, loose object of intermediate C3 quality. It is located at a large distance from the Sun, well below the mid-plane. It was recently reported but it is moderately studied in the literature.<br><br><span style="color: #99180f; font-weight: bold;">Warning: </span>contains less than 25 stars with <i>P>0.5</i> estimated.
class3: |
