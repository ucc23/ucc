...
UTI_C_dup: 1.0
UTI_summary: |
    <b>Teutsch 176</b> is a rich, very dense object of high C3 quality. It is located at a close distance from the Sun, below the mid-plane. It is poorly studied in the literature.<br><br>This object shares a large percentage of members with 2 later reported entries.
class3: |
...
posit_table: |
    ...
    |[Zhang et al. (2024)](https://scixplorer.org/abs/2024A%26A...692A.212Z) | 58.21 | 45.975 | -- | -- | -- | -- |
...
fpars_table: |
    ...
    | [Hunt & Reffert (2024)](https://scixplorer.org/abs/2024A%26A...686A..42H) | `MassJ=407.738, MassTot=409.141` |
    | [Zhang et al. (2024)](https://scixplorer.org/abs/2024A%26A...692A.212Z) | `[Fe/H]ANN=-0.0755, [Fe/H]MCMC=-0.0010` |
shared_table: |
