...
UTI_C_dup: 1.0
UTI_summary: |
    <b>FoF 676</b> is a moderately populated, very dense object of very high C3 quality. It is located at a moderate distance from the Sun, below the mid-plane. It is rarely studied in the literature.<br><br>This object shares a large percentage of members with 3 later reported entries.
class3: |
...
posit_table: |
    ...
    |[Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | 149.023 | -60.176 | -- | -- | -- | -- |
...
fpars_table: |
    ...
    | [Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | `AV=0.658, Dist=2411, logAge=9.516, MassRk=418.0` |
shared_table: |
