...
UTI_C_dup: 1.0
UTI_summary: |
    <b>UBC 40</b> is a poorly populated, very dense object of intermediate C3 quality. It is located at a moderate distance from the Sun, below the mid-plane. It is poorly studied in the literature.
class3: |
...
posit_table: |
    ...
    |[Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | 22.633 | 60.244 | -- | -- | -- | -- |
...
fpars_table: |
    ...
    | [Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | `AV=1.38, Dist=2228, logAge=8.036, MassRk=343.5` |
shared_table: |
