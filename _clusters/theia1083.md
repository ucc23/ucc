...
UTI_C_dup: 1.0
UTI_summary: |
    <b>Theia 1083</b> is a sparse, moderately dense object of low C3 quality. It is located at a close distance from the Sun, near the mid-plane. It was recently reported in the literature.<br><br><span style="color: #99180f; font-weight: bold;">Warning: </span>contains less than 25 stars with <i>P>0.5</i> estimated.
class3: |
...
posit_table: |
    ...
    |[Zhang et al. (2024)](https://scixplorer.org/abs/2024A%26A...692A.212Z) | 69.253 | 48.524 | -- | -- | -- | -- |
...
fpars_table: |
    ...
    | [Hunt & Reffert (2024)](https://scixplorer.org/abs/2024A%26A...686A..42H) | `MassJ=71.6799, MassTot=88.1247` |
    | [Zhang et al. (2024)](https://scixplorer.org/abs/2024A%26A...692A.212Z) | `[Fe/H]ANN=-0.2812, [Fe/H]MCMC=-0.2750` |
