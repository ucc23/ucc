...
UTI_C_dup: 0.09
UTI_summary: |
    <b>Teutsch 118</b> is a rich, very dense object of very high C3 quality. It is located at a moderate distance from the Sun, below the mid-plane. It is moderately studied in the literature.<br><br><span style="color: #99180f; font-weight: bold;">Warning: </span>This is very likely a duplicate object, which shares a large percentage of members with at least one previously reported entry.
class3: |
...
posit_table: |
    ...
    | :---         | :---: | :---: | :---: | :---: | :---: | :---: |
    |[Kronberger et al. (2006)](https://scixplorer.org/abs/2006A%26A...447..921K) | 287.038 | 4.233 | -- | -- | -- | -- |
