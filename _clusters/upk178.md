...
UTI_C_dup: 1.0
UTI_summary: |
    <b>UPK 178</b> is a moderately populated, very dense object of high C3 quality. It is located at a close distance from the Sun, above the mid-plane. It is moderately studied in the literature.
class3: |
...
posit_table: |
    ...
    |[Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | 334.438 | 60.084 | -- | -- | -- | -- |
...
fpars_table: |
    ...
    | [Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | `AV=2.326, Dist=910, logAge=8.169, MassRk=74.5` |
shared_table: |
