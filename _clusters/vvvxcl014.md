...
<!-- WEBP image -->
<img id="myImage" src="https://raw.githubusercontent.com/ucc23/Q4N/main/plots/vvvxcl014_aladin.webp" alt="Clickable Image" style="width:355px;height:250px; cursor: pointer;">
...
function loadAladinLiteAndHideImage() {
    ...
    aladinScript.onload = function () {
        A.init.then(() => {
            let aladin = A.aladin('#aladin-lite-div', {survey:"P/DSS2/color", fov:0.02, target: "202.943 -64.936"});
            // Remove the image
