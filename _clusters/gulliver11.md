...
UTI_C_dup: 1.0
UTI_summary: |
    <b>Gulliver 11</b> is a moderately populated, very dense object of high C3 quality. It is located at a close distance from the Sun, near the mid-plane. It is moderately studied in the literature.<br><br>This object shares a large percentage of members with a later reported entry.
class3: |
...
posit_table: |
    ...
    | :---         | :---: | :---: | :---: | :---: | :---: | :---: |
    |[Cantat-Gaudin et al. (2018)](https://scixplorer.org/abs/2018A%26A...618A..93C) | 67.996 | 43.62 | 1.061 | 0.4 | -2.229 | -- |
    |[Monteiro & Dias (2019)](https://scixplorer.org/abs/2019MNRAS.487.2385M) | 67.996 | 43.62 | -- | -- | -- | 2.455 |
    ...
    |[Zhang et al. (2024)](https://scixplorer.org/abs/2024A%26A...692A.212Z) | 68.009 | 43.613 | -- | -- | -- | -- |
    |[Alfonso et al. (2024)](https://scixplorer.org/abs/2024A%26A...689A..18A) | 68.003 | 43.619 | 1.031 | 0.304 | -2.303 | -- |
    |[Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | 68.016 | 43.602 | -- | -- | -- | -- |
...
fpars_table: |
    | Reference |  Values |
    | :---  |  :---:  |
    | [Cantat-Gaudin et al. (2018)](https://scixplorer.org/abs/2018A%26A...618A..93C) | `dmode=917.3` |
    | [Monteiro & Dias (2019)](https://scixplorer.org/abs/2019MNRAS.487.2385M) | `E(B-V)=0.393, Dist=1.061, logAge=8.482, Z=0.026` |
    | [Cantat-Gaudin et al. (2020)](https://scixplorer.org/abs/2020A%26A...640A...1C) | `AVNN=0.76, DistPc=907.0, AgeNN=8.51` |
    ...
    | [Hunt & Reffert (2024)](https://scixplorer.org/abs/2024A%26A...686A..42H) | `MassJ=179.001, MassTot=222.926` |
    | [Zhang et al. (2024)](https://scixplorer.org/abs/2024A%26A...692A.212Z) | `[Fe/H]ANN=-0.2400, [Fe/H]MCMC=-0.2399` |
    | [Alfonso et al. (2024)](https://scixplorer.org/abs/2024A%26A...689A..18A) | `AV=0.76152, MOD=9.75532, logAge=8.52299, Z=-0.0885` |
    | [Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | `AV=1.526, Dist=925, logAge=8.535, MassRk=157.6` |
shared_table: |
