...
<!-- WEBP image -->
<img id="myImage" src="https://raw.githubusercontent.com/ucc23/Q2N/main/plots/gulliver8_aladin.webp" alt="Clickable Image" style="width:355px;height:250px; cursor: pointer;">
...
function loadAladinLiteAndHideImage() {
    ...
    aladinScript.onload = function () {
        A.init.then(() => {
            let aladin = A.aladin('#aladin-lite-div', {survey:"P/DSS2/color", fov:0.253, target: "80.573 33.795"});
            // Remove the image
...
| :---:   | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|[HXWHB 8](https://ucc.ar/_clusters/hxwhb8/)| 84 | 80.573 | 33.786 | 0.914 | -0.33 | -3.076 | -5.343 |

> <p style="text-align:center; font-weight: bold; font-size:20px">Search coordinates in <a href="https://cdsportal.u-strasbg.fr/?target=80.573,+33.795" target="_blank">CDS</a> | <a href="https://simbad.cds.unistra.fr/mobile/object_list.html?coord=80.573%2033.795&output=json&radius=5&userEntry=gulliver8" target="_blank">Simbad</a></p>
...
| [Dias et al. (2021)](https://ui.adsabs.harvard.edu/abs/2021MNRAS.504..356D) | `Av=0.99, Dist=1114.0, logage=7.47, [Fe/H]=0.07` |
