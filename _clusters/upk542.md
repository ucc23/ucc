...
UTI_C_dup: 1.0
UTI_summary: |
    <b>UPK 542</b> is a poorly populated, loose object of intermediate C3 quality. It is located at a close distance from the Sun, below the mid-plane. It is moderately studied in the literature.
class3: |
...
posit_table: |
    ...
    |[Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | 134.113 | -54.299 | -- | -- | -- | -- |
...
fpars_table: |
    ...
    | [Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | `AV=0.684, Dist=797, logAge=8.637, MassRk=78.4` |
