...
UTI_C_dup: 1.0
UTI_summary: |
    <b>COIN-Gaia 7</b> is a moderately populated, very dense object of high C3 quality. It is located at a relatively close distance from the Sun, near the mid-plane. It is moderately studied in the literature.<br><br>This object shares a significant percentage of members with 2 later reported entries.
class3: |
...
posit_table: |
    ...
    | :---         | :---: | :---: | :---: | :---: | :---: | :---: |
    |[Cantat-Gaudin et al. (2019)](https://scixplorer.org/abs/2019A%26A...624A.126C) | 33.738 | 58.466 | 0.65 | -1.04 | -1.56 | -- |
    |[Monteiro & Dias (2019)](https://scixplorer.org/abs/2019MNRAS.487.2385M) | 33.738 | 58.466 | -- | -- | -- | 2.478 |
    ...
    |[Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | 33.712 | 58.443 | -- | -- | -- | -- |
...
fpars_table: |
    | Reference |  Values |
    | :---  |  :---:  |
    | [Cantat-Gaudin et al. (2019)](https://scixplorer.org/abs/2019A%26A...624A.126C) | `d=1477` |
    | [Monteiro & Dias (2019)](https://scixplorer.org/abs/2019MNRAS.487.2385M) | `E(B-V)=0.513, Dist=1.475, logAge=8.014, Z=0.014` |
    | [Cantat-Gaudin et al. (2020)](https://scixplorer.org/abs/2020A%26A...640A...1C) | `AVNN=1.36, DistPc=1485.0, AgeNN=7.76` |
    ...
    | [Hunt & Reffert (2024)](https://scixplorer.org/abs/2024A%26A...686A..42H) | `MassJ=385.682, MassTot=417.828` |
    | [Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | `AV=1.681, Dist=1334, logAge=7.941, MassRk=195.0` |
shared_table: |
