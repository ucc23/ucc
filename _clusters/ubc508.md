...
<!-- WEBP image -->
<img id="myImage" src="https://raw.githubusercontent.com/ucc23/Q4N/main/plots/ubc508_aladin.webp" alt="Clickable Image" style="width:355px;height:250px; cursor: pointer;">
...
function loadAladinLiteAndHideImage() {
    ...
    aladinScript.onload = function () {
        A.init.then(() => {
            let aladin = A.aladin('#aladin-lite-div', {survey:"P/DSS2/color", fov:0.253, target: "164.122 -60.477"});
            // Remove the image
...
| :---:   | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|[ASCC 63](https://ucc.ar/_clusters/ascc63/)| 65 | 164.102 | -60.479 | 0.158 | -5.258 | 2.251 | 16.954 |

> <p style="text-align:center; font-weight: bold; font-size:20px">Search coordinates in <a href="https://cdsportal.u-strasbg.fr/?target=164.122,-60.477" target="_blank">CDS</a> | <a href="https://simbad.cds.unistra.fr/mobile/object_list.html?coord=164.122%20-60.477&output=json&radius=5&userEntry=ubc508" target="_blank">Simbad</a></p>
...
| [Dias et al. (2021)](https://ui.adsabs.harvard.edu/abs/2021MNRAS.504..356D) | `Av=2.16, Dist=5090.0, logage=8.78, [Fe/H]=0.14` |
