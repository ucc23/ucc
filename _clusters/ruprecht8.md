...
UTI_C_dup: 1.0
UTI_summary: |
    <b>Ruprecht 8</b> is a moderately populated, moderately dense object of high C3 quality. It is located at a moderate distance from the Sun, below the mid-plane. It is moderately studied in the literature.<br><br>This object shares a large percentage of members with a later reported entry.
class3: |
...
posit_table: |
    ...
    | :---         | :---: | :---: | :---: | :---: | :---: | :---: |
    |[Kharchenko et al. (2013)](https://scixplorer.org/abs/2013A%26A...558A..53K) | 105.438 | -13.56 | -- | 1.17 | -0.26 | -- |
    |[Kharchenko et al. (2016)](https://scixplorer.org/abs/2016A%26A...585A.101K) | 105.432 | -13.558 | -- | -- | -- | -- |
    ...
    |[Just et al. (2023)](https://scixplorer.org/abs/2023A%26A...672A.187J) | 105.432 | -13.558 | -- | -- | -- | -- |
    ...
    |[Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | 105.423 | -13.527 | -- | -- | -- | -- |
...
fpars_table: |
    | Reference |  Values |
    | :---  |  :---:  |
    | [Kharchenko et al. (2013)](https://scixplorer.org/abs/2013A%26A...558A..53K) | `E(B-V)=0.458, d=2190.0, logt=8.845` |
    | [Kharchenko et al. (2016)](https://scixplorer.org/abs/2016A%26A...585A.101K) | `E(B-V)=0.458, d=2190.0, logt=8.845` |
    | [Cantat-Gaudin et al. (2020)](https://scixplorer.org/abs/2020A%26A...640A...1C) | `AVNN=1.03, DistPc=2251.0, AgeNN=8.6` |
    | [Dias et al. (2021)](https://scixplorer.org/abs/2021MNRAS.504..356D) | `Av=1.354, Dist=1833, logage=8.589, [Fe/H]=-0.086` |
    | [Just et al. (2023)](https://scixplorer.org/abs/2023A%26A...672A.187J) | `logt=8.845, logmt=1.975` |
    ...
    | [Hunt & Reffert (2024)](https://scixplorer.org/abs/2024A%26A...686A..42H) | `MassJ=515.452, MassTot=643.577` |
    | [Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | `AV=1.354, Dist=1833, logAge=8.589, MassRk=285.1` |
