...
UTI_C_dup: 0.1
UTI_summary: |
    <b>COIN-Gaia 17</b> is a rich, very dense object of high C3 quality. It is located at a relatively close distance from the Sun, near the mid-plane. It is poorly studied in the literature.<br><br><span style="color: #99180f; font-weight: bold;">Warning: </span>This is likely a duplicate object, which shares a large percentage of members with at least one previously reported entry.
class3: |
...
posit_table: |
    ...
    | :---         | :---: | :---: | :---: | :---: | :---: | :---: |
    |[Cantat-Gaudin et al. (2019)](https://scixplorer.org/abs/2019A%26A...624A.126C) | 81.244 | 37.558 | 0.89 | 0.36 | -4.28 | -- |
    |[Monteiro & Dias (2019)](https://scixplorer.org/abs/2019MNRAS.487.2385M) | 81.244 | 37.558 | -- | -- | -- | 2.668 |
    ...
    |[Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | 81.22 | 37.538 | -- | -- | -- | -- |
...
fpars_table: |
    | Reference |  Values |
    | :---  |  :---:  |
    | [Cantat-Gaudin et al. (2019)](https://scixplorer.org/abs/2019A%26A...624A.126C) | `d=1094` |
    | [Monteiro & Dias (2019)](https://scixplorer.org/abs/2019MNRAS.487.2385M) | `E(B-V)=0.418, Dist=1.253, logAge=8.425, Z=0.018` |
    ...
    | [Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | `AV=1.477, Dist=1039, logAge=7.934, MassRk=264.8` |
shared_table: |
