...
UTI_C_dup: 1.0
UTI_summary: |
    <b>UPK 537</b> is a sparse, very loose object of low C3 quality. It is located at a close distance from the Sun, below the mid-plane. It is moderately studied in the literature.<br><br><span style="color: #99180f; font-weight: bold;">Warning: </span>contains less than 25 stars with <i>P>0.5</i> estimated.
class3: |
...
posit_table: |
    ...
    |[Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | 126.645 | -52.013 | -- | -- | -- | -- |
...
fpars_table: |
    ...
    | [Cantat-Gaudin et al. (2020)](https://scixplorer.org/abs/2020A%26A...640A...1C) | `AVNN=0.54, DistPc=628.0, AgeNN=8.37` |
    ...
    | [Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | `AV=0.713, Dist=595, logAge=8.02, MassRk=107.5` |
shared_table: |
