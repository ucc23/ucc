...
UTI_C_dup: 1.0
UTI_summary: |
    <b>FoF 373</b> is a moderately populated, dense object of high C3 quality. It is located at a moderate distance from the Sun, above the mid-plane. It is rarely studied in the literature.<br><br>This object shares a large percentage of members with 3 later reported entries.
class3: |
...
posit_table: |
    ...
    |[Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | 105.579 | -1.84 | -- | -- | -- | -- |
...
fpars_table: |
    ...
    | [Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | `AV=1.201, Dist=3115, logAge=8.228, MassRk=1539.0` |
shared_table: |
