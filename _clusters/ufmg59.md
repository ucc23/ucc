...
UTI_C_dup: 1.0
UTI_summary: |
    <b>UFMG 59</b> is a moderately populated, very dense object of low C3 quality. It is located at a relatively close distance from the Sun, near the mid-plane. It is moderately studied in the literature.
class3: |
...
posit_table: |
    ...
    |[Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | 126.496 | -38.339 | -- | -- | -- | -- |
...
fpars_table: |
    | Reference |  Values |
    | :---  |  :---:  |
    | [Ferreira et al. (2020)](https://scixplorer.org/abs/2020MNRAS.496.2021F) | `E(B-V)=0.5, Dist=1337, logt=7.65` |
    ...
    | [Hunt & Reffert (2024)](https://scixplorer.org/abs/2024A%26A...686A..42H) | `MassJ=121.906, MassTot=140.129` |
    | [Almeida et al. (2025)](https://scixplorer.org/abs/2025A%26A...693A.305A) | `AV=1.287, Dist=1330, logAge=7.701, MassRk=67.2` |
shared_table: |
